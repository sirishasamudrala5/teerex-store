...
import {FilterMobileProps} from "../constants/IProps"

const FiltersMobileView = (props:FilterMobileProps) => {
    return <Transition.Root show={props.mobileFiltersOpen} as={Fragment}>
...
export default FiltersMobileView