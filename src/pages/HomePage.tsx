...
const HomePage = (props) => {
  ...
  console.log("homepage", props.cart)
          ...
          <section aria-labelledby="products-heading" className="pt-6 pb-24">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <div className="lg:col-span-3">
                <Products {...props} outOfStock={filterOutOfStock} type={filterType} gender={filtergender} price={filterPrice} color={filterColor} searchStr={searchStr} />
              </div>
            </div>
          </section>
        </main>
